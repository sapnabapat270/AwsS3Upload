...
const UserPoolId = 'ap-south-1_1VM9wbo91';
const ClientId = '1qke6ucmq09gr0dcd7id4nq9c4';
const ApiGatewayUrl = 'https://er4s3i48ja.execute-api.ap-south-1.amazonaws.com/prod/sentisumupload';
...
export default class App extends Component {
  ...
  onDrop = (files) => {
    ...
    axios.get(ApiGatewayUrl, {headers: {
        Authorization: this.state.accessToken}}).then((response) => {
